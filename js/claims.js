...
(function () {
  const claimCases = [
    ...
    { title:'人工關節', series:'常見理賠案例 06', folder:'common joint', categories:['medical','surgery','hospital'], tags:['#醫療實支','#手術定額'], summary:'人工關節常有自費醫材，保障額度是否足夠，客戶看案例最有感。', keywords:'人工關節 關節 醫材 自費醫材 手術 醫療實支', url:'https://godzillapaul.github.io/claim-artificial_joint-06/' },
    { title:'意外受傷', series:'常見理賠案例 07', folder:'common accident property', categories:['accident-medical','accident-hospital','fracture'], tags:['#意外實支','#意外住院','#意外骨折'], summary:'跌倒、車禍、運動傷害等情境，可快速理解意外保障的啟動方式。', keywords:'意外受傷 車禍 跌倒 運動傷害 骨折 意外實支 意外住院 產險', url:'https://godzillapaul.github.io/claim-accidental_injury-07/' },
    ...
    { title:'椎間盤', series:'常見理賠案例 09', folder:'common back', categories:['medical','surgery','accident-medical'], tags:['#醫療實支','#手術定額'], summary:'椎間盤治療可能橫跨復健、手術與自費項目，適合拿來做保障檢查。', keywords:'椎間盤 椎間盤突出 腰椎 脊椎 腰背 手術 醫療實支', url:'' },
    { title:'幼兒常見', series:'常見理賠案例 10', folder:'common children', categories:['medical','hospital'], tags:['#醫療實支','#住院定額'], summary:'小孩常見疾病住院，最能讓父母理解醫療保障不是大人才需要。', keywords:'幼兒 兒童 小孩 肺炎 腸胃炎 發燒 住院 醫療實支', url:'' },
    { title:'長照／失能', series:'常見理賠案例 11', folder:'common', categories:['ltc','major','medical'], tags:['#長照失能','#重大傷病'], summary:'當照護時間拉長，重點不只是醫療費，而是長期照顧與家庭現金流壓力。', keywords:'長照 失能 失智 巴氏量表 看護 照護 重大傷病', url:'' },
    { title:'重大傷病／疾病', series:'常見理賠案例 12', folder:'common cancer heart organ', categories:['major','medical','hospital'], tags:['#重大傷病','#醫療實支'], summary:'重大傷病卡、疾病治療與一次金保障，能讓客戶看懂大風險的資金需求。', keywords:'重大傷病 重疾 重大疾病 疾病 一次金 醫療實支 住院', url:'' }
  ];
